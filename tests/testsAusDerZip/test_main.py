...
# # Pfad zur main.py Datei hinzufügen
...
#         encoded_password = base64.b64encode(hashlib.sha256(b'password').digest()).decode('utf-8')
...
#     @patch('builtins.open', new_callable=mock_open, read_data='{}')
#     @patch('os.path.exists', return_value=True)
#     @patch('main.getTime', return_value="2024-08-29 12:00:00")
...
#         mock_datetime.now.return_value = datetime.datetime(2024, 8, 29, 12, 0, 0)
#         time_string = getTime()
...
#     @patch('main.checkPawndedApi')
#     @patch('main.curses.initscr')
#     @patch('main.curses.start_color')
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_safe_password(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_short_password(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
#         mock_checkPawndedApi.return_value = False
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_missing_uppercase(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
#         mock_checkPawndedApi.return_value = False
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_missing_number(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
#         mock_checkPawndedApi.return_value = False
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_missing_special_char(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
#         mock_checkPawndedApi.return_value = False
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_password_leaked(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_checkPawndedApi):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getmaxyx.return_value = (20, 75)
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_custom_password_safe(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_safePassword, mock_pwChecker):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
...
#         mock_stdscr.addstr.assert_any_call(0, 0, "Enter your desired password: ")
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_custom_password_not_safe_edit(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_safePassword, mock_pwChecker):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
...
#     @patch('main.curses.init_pair')
#     @patch('main.curses.newwin')
#     def test_custom_password_not_safe_do_not_edit(self, mock_newwin, mock_init_pair, mock_start_color, mock_initscr, mock_safePassword, mock_pwChecker):
#         mock_stdscr = Mock()
#         mock_newwin.return_value = mock_stdscr
#         mock_stdscr.getstr.return_value = b'WeakPassword'
#         mock_pwChecker.return_value = False
